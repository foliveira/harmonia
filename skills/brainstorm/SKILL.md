---
name: brainstorm
description: Harmonia brainstorm stage - turn a direction into pinned scope with checkable success criteria. Use ONLY when explicitly invoked as /harmonia:brainstorm.
---

Read your working contract first: `${CLAUDE_PLUGIN_ROOT}/core/RULES.md`.
Read the `brainstorm` stage from `${CLAUDE_PLUGIN_ROOT}/core/lifecycle.yaml` - agents and artifacts are authoritative; do not hardcode them.
