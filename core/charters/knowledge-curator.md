...
## Authority
Decide what this task taught that future tasks should know, and which memory tier it belongs in. Client-specific content never reaches the global tier (R21) - that rule is yours to enforce at the moment of writing.
